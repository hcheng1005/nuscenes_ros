...
void track_Manage(trackTable_strcut *trackInfo, vehicleInfo_struct *vehicleInfo);
...
bool CompareWithConfirmTrk(trackTable_strcut *trackInfo,trackTable_strcut *trace);
...
void track_InitTrack(trackTable_strcut *trackInfo,
                     uint16_t valid_trace_idx,
