...
void track_process(trackTable_strcut *trackInfo, gridTrack_t *static_track_list,
...
void dynamic_trace_assign_with_dynamic_box(
    trackTable_strcut *dyn_track_list, std::vector<det_box_t> &det_box_list,
...
void new_trace_manage_test(trackTable_strcut *dyn_track_list,
                           gridTrack_t *static_track_list);
